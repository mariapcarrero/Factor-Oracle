...
TEST_CASE( "FactorOracleStart empty string (pass)", "[classic]") {
...
TEST_CASE( "FactorOracleStart a (pass) with string a", "[classic]") {
    FactorOracle oracle_relations;
    string word = "a";
    int len = word.size();
    oracle_relations.FactorOracleStart(oracle_relations, word);
...
TEST_CASE( "FactorOracleStart long string (160 chars) (pass) with len+1 states", "[classic]") {
    FactorOracle oracle_relations;
...
TEST_CASE( "FactorOracleStart symbol = word[len]", "[classic]") {
    FactorOracle oracle_relations;
    string word = "asafaslkdjasdlkasdjkasalsasdklasdljasdklasjdlaskdjaskldjasldkasdklasdlaaskjdajsdlkasjdlaskdajlsdjalskdajsdlaksdjalsdkaslasjdlaksdalsdjalsdalskdjalsdkjasdsldalkd";
    int len = word.size();
    oracle_relations.FactorOracleStart(oracle_relations, word);
